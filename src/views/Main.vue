<style lang="scss">
  @import "./main.scss";
  @import '../assets/public/common.scss';
</style>
<template>
    ...
    <div class="sidebar-menu-con" :style="{width: shrink?'60px':'200px', overflow: shrink ? 'visible' : 'auto'}">
      <shrinkable-menu
        ...
        <div slot="top" class="logo-con">
                    <span class="logo-shrink" v-show="!shrink" style="padding-left: 10px;">
                        <!--<img src="../images/logo-min.png" key="max-logo"/>-->
                        <h3>美亚乐洗管理</h3>
                    </span>
          <span class="logo-shrink-min" v-show="shrink">
...
<script>
  ...
  export default {
    ...
    computed: {
      userName() {
        return (typeof getStrUserName !== 'undefined') ? getStrUserName : '';
      },
      menuList() {
    ...
    methods: {
      ...
      loginOut() {
        this.$axios.post(`${this.$api.loginOut}`).then((res) => {
          if (res.data.success) {
